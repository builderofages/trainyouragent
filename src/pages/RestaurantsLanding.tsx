        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-4">
              8 Ways AI Transforms Your Restaurant
            </h2>
          ...
          <ComprehensiveSolutionsGrid 
            businessFunctions={comprehensiveSolutions.restaurants.businessFunctions}
          />
          ...
          >
            <MagneticButton
              size="lg"
              onClick={() => {
                conversions.ctaClicked("restaurants_solutions_cta");
                setLeadGateOpen(true);
              }}
