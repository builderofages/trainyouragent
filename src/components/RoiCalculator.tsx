  ...
  return (
    <div className="rounded-3xl bg-white border border-slate-200 p-6 sm:p-8 shadow-[0_4px_40px_-12px_rgba(4,44,83,0.18)]" style={{ fontFamily: "'Inter Tight', system-ui, sans-serif" }}>
      <div className="flex items-baseline justify-between mb-1 flex-wrap gap-2">
        ...
        <div className="text-[11px] text-slate-500">Operators plan · $799/mo baseline</div>
      </div>
      ...
      <div className="mt-3 text-[11px] text-slate-500">Estimates use a 70% missed-call recovery rate and 78% support-deflection benchmark from real production builds.</div>
    </div>
  );
}
