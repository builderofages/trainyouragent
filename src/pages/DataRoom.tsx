...
const METRICS = [
 ...
 { label: "Founder track record", value: "4 yrs", note: "Applied AI, plus prior LA SMMA + TrainYourAgent" },
...
export default function DataRoom() {
 ...
 <div className="text-[13px] text-slate-600 mb-3">Tampa Bay, FL · 4 years in applied AI · Prior: social strategy lead at a top-tier LA agency, founder of TrainYourAgent.</div>
