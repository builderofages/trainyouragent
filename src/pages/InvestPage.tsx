...
const PITCH = [
  { title: "Current stage", body: "Pre-customer in this exact site/product configuration — the rest of the operating business (Four years in applied AI, prior SMB and agency work) underwrites runway. The trainyouragent.com product is being built and shipped in public: 336 commits, 564 live URLs, audited security posture. Founding-customer slots open now." },
