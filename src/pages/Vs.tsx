...
const ALTERNATIVES = [
  ...
  },
  {
    ...
    us: "Engineering is the primary skill. The paid social is downstream of having something real to sell. The team has shipped at LA SMMA, top-3 US telecom, and 10+ years of gaming engineering before they built voice agents.",
  },
];
...
const FAQS = [
  {
    ...
    answer:
      "TrainYourAgent is built and operated by a senior operator network — a founder with executive experience at one of LA's largest social media agencies, a CRM and operations lead embedded at a top-3 US telecom carrier, and a lead engineer with 10+ years of gaming and brand engineering. Most 2026 AI agencies are resellers: they wrap a no-code voice AI platform, mark it up 4×, and sell it on Instagram. We build production voice agents end-to-end, ship them in 21 days, and operate them ourselves on your live phone line.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "A small, deliberately senior operator network. Alexander Mills (founder) was a head executive at one of the world's largest LA social media agencies and founded EndCreations in the gaming infrastructure space; he has been shipping in applied AI since the GPT-3 alpha. The CRM and operations lead is a senior currently embedded at one of the largest telecommunications companies on Earth — the same scale that handles ten-figure call volumes. The lead engineer has 10+ years of gaming and brand engineering experience shipping custom integrations and real-time pipelines.",
  },
  {
      ...
      <header className="relative pt-32 sm:pt-44 pb-12 sm:pb-20 px-5 sm:px-8 overflow-hidden">
        <div className="max-w-[1080px] mx-auto relative z-10">
          ...
          <p id="vs-lede" className="mt-6 max-w-[780px] text-[17px] sm:text-[19px] leading-[1.6] text-[rgba(230,241,251,0.78)]">
            ...
            agency, a top-3 US telecom carrier, and high-stakes gaming
