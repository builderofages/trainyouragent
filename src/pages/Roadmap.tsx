      ...
      <footer className="bg-white border-t border-slate-200">
        <div className="max-w-7xl mx-auto px-5 sm:px-8 py-10 flex flex-col md:flex-row items-center justify-between gap-4 text-[13px] text-slate-600">
          ...
          <div className="flex items-center gap-6">
            <Link to="/legal/privacy" className="hover:text-[#042C53]">Privacy</Link>
            <Link to="/legal/terms" className="hover:text-[#042C53]">Terms</Link>
            <Link to="/status" className="hover:text-[#042C53]">Status</Link>
            {/* v78: /changelog dropped — no Route registered for it (orphan
                Changelog.tsx). Closest live equivalent is the founder log. */}
            <Link to="/founder-log" className="hover:text-[#042C53]">Founder log</Link>
