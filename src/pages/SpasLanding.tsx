  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-mesh">
        ...
        <HeroSectionEnhanced
          industry="spas"
          headline="Never Miss Another Booking — AI That Runs Your Front Desk 24/7"
          subheadline="Convert more inquiries, reduce no-shows, and free your team to focus on client experience. Deploy in 3-7 days."
        ...
        {/* Pain Points Journey */}
        <PainPointsJourney industry="spas" />
        
        {/* Industry Benefits */}
        <IndustryBenefits industry="spas" />
