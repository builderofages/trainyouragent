...
export default function Speaking() {
  useEffect(() => {
    ...
    {
      const ogImage = `https://trainyouragent.com/api/og?title=${encodeURIComponent("Book Alexander to speak")}&subtitle=${encodeURIComponent("AI agents in production · operators & teams")}&type=trust&badge=SPEAKING`;
