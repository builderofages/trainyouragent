        ...
        <div className="max-w-6xl mx-auto grid lg:grid-cols-[1fr_1.5fr] gap-10">
          ...
          <div>
            ...
            <p className="text-[15px] text-slate-700 leading-relaxed">
              United States. Reachable for press at <a href="mailto:press@trainyouragent.com" className="underline text-[#185FA5]">press@trainyouragent.com</a>. Photo credit on use: "Courtesy of TrainYourAgent." Free for editorial use; commercial use by permission.
            </p>
          </div>
        </div>
      </section>
